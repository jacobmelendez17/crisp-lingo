...
export function ProgressCard() {
	const levels = [
		{ title: 'Beginner Pup', color: 'bg-[#e5d7c4]' },
		{ title: 'Pond Treader', color: 'bg-[#cfbb99]' },
		{ title: 'River Rider', color: 'bg-[#889063]' },
		{ title: 'Expert Swimmer', color: 'bg-[#354024]' },
		{ title: 'Pro Diver', color: 'bg-[#4c3d19]' }
	];
